/*
 * WBC1-CASCADE-NEW0 -- последовательные 32 раунда (без кэша составной перестановки)
 * ===================================================================================
...
static void benchmark(const uint8_t key[32], EncMode mode, int double_pass) {
    ...
    {
        const char *env = getenv("WBC_BENCH_1GB");
        if (env && env[0] == '1') { sizes = sizes_1gb; ns = (int)(sizeof(sizes_1gb)/sizeof(sizes_1gb[0])); }
    }
...
int main(int argc, char *argv[]) {
    ...
    printf("\n");
    printf("╔══════════════════════════════════════════════════════════╗\n");
    printf("║      WBC1-CASCADE-NEW0  (32 раунда: перестановка+сдвиг) ║\n");
    printf("╠══════════════════════════════════════════════════════════╣\n");
    printf("║  Каскад:  %-46s ║\n",
