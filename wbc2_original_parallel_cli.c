        ...
        for (int i = 1; i < argc; i++) {
            if (strcmp(argv[i], "--task-encrypt") == 0 || strcmp(argv[i], "--encrypt") == 0) {
                task = 0;
                       ...
                       strcmp(argv[i], "--task-benchmark") == 0 || strcmp(argv[i], "--benchmark") == 0 || strcmp(argv[i], "--bench") == 0) {
                task = 1;
                ...
                if (strcmp(v, "0") == 0 || strcmp(v, "encrypt") == 0 || strcmp(v, "demo") == 0) task = 0;
                         ...
                         strcmp(v, "benchmark") == 0 || strcmp(v, "bench") == 0) task = 1;
                ...
                if (rank == 0) {
                    printf("Usage (named): %s --task <encrypt|analysis|table> [--key-size 256] [--key-source random] [--block-size 128|0] [--mode demo|random|simple|full] [--size KB] [--rounds N]\n", argv[0]);
