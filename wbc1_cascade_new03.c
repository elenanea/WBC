/*
 * WBC1-CASCADE-NEW03 -- легкие операции + легкий раунд
 * =====================================================
 ...
 *
 * Build:
 *   gcc -O3 -march=native -o wbc1_cascade_new03 wbc1_cascade_new03.c -lssl -lcrypto -lm
 */
...
#define MAGIC_LEN    4
#define VERSION      0x01
#define VERSION_CASC 0x07   /* NEW03: lightweight op table + XOR+bitwise shift */
...
int main(int argc, char *argv[]) {
    ...
    printf("\n");
    printf("╔══════════════════════════════════════════════════════════╗\n");
    printf("║ WBC1-CASCADE-NEW03 (32 раунда: op -> XOR RK -> bit-shift) ║\n");
    printf("╠══════════════════════════════════════════════════════════╣\n");
    printf("║  Каскад:  %-46s ║\n",
