/*
 * CLI wrapper for wbc1_fixed_cascade2.c (WBC1.1 - cascade v2 with mix, enhanced)
 * Usage: cli_wbc1_casc2 [enc_mode]
...
#define main cascade2_main_unused
#include "../wbc1_fixed_cascade2.c"
#undef main

#include "cli_wbc_serial_common.h"

static void __attribute__((unused)) suppress_unused2(void) {
    (void)cascade2_main_unused;
}
