...
- **$\pi_i$** — $i$-я операция перестановки: $\pi_i: \{0,\ldots,15\} \to \{0,\ldots,15\}$
- **$\pi_i^{-1}$** — обратная операция: $\pi_i^{-1}(\pi_i(X)) = X$
...
- **87 базовых операций**: повороты граней куба Рубика (face, slice, wide, swap, cube, alg, pattern, diagflip)
- **20 динамических операций**: композиции 2-6 базовых операций
- **20 дополнительных динамических операций**: более сложные композиции
